...
public class KotlinJavascriptDeserializerForDecompiler(
    ...
    private val nameResolver: NameResolver = run {
        ...
        val stringsFileName = BuiltInsSerializationUtil.getStringTableFilePath(directoryPackageFqName)
    ...
    override val annotationAndConstantLoader = BuiltInsAnnotationAndConstantLoader(moduleDescriptor)

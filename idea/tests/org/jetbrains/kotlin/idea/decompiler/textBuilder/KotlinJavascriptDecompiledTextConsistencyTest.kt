...
public class KotlinJavascriptDecompiledTextConsistencyTest : JetLightCodeInsightFixtureTestCase() {
...
class KotlinJavascriptResolverForDecompiler() : ResolverForDecompiler {

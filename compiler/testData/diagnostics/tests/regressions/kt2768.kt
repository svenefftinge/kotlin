...
fun main(args: Array<String>) {
    ...
    // unclear place
    assertEquals(128, byteNeg.<!OVERLOAD_RESOLUTION_AMBIGUITY!>toInt<!>()) // passes, should not be possible
    ...
    // unclear place
    assertEquals(32768, shortNeg.<!OVERLOAD_RESOLUTION_AMBIGUITY!>toInt<!>()) // passes, should not be possible

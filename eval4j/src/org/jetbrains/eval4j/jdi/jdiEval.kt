...
public class JDIEval(
    ...
    public fun boxType(value: Value): Value {
        val method = when (value.asmType) {
            Type.BYTE_TYPE -> MethodDescription("java/lang/Integer", "valueOf", "(B)Ljava/lang/Byte;", false)
            Type.SHORT_TYPE -> MethodDescription("java/lang/Integer", "valueOf", "(S)Ljava/lang/Short;", false)
            Type.LONG_TYPE -> MethodDescription("java/lang/Integer", "valueOf", "(J)Ljava/lang/Long;", false)
